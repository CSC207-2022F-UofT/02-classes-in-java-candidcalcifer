...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param first first name for this Silly instance.
     * @param second second name for this Silly instance.
     */
    ...
    public int compareTo(Silly other) {
         ...
         *                .length() method.
         */
        return Integer.compare(this.name.length(), ((Silly) other).toString().length());
    }
